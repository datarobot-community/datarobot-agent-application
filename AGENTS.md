...
Should be ran after before and after agent code modification (in the same directory where AGENTS.md is located):
...
def agent_node(self) -> Any:
    return create_react_agent(
        ...
        tools=self.mcp_tools,  # or [] for no tools
...
**Important** Not implemented yet and should be skipped.
