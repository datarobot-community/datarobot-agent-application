...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      // Layout
      `
              group h-9 px-3 py-2 flex w-full items-center justify-between
              whitespace-nowrap
            `,
      // Appearance
      `
              text-sm rounded-lg border border-border bg-input text-foreground
      ...
      `
              ...
              enabled:hover:data-[placeholder]:text-[color-mix(in_oklch,var(--muted-foreground)_80%,white)]
            `,
      'transition-colors',
      // States
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown
        className={`
                  size-4 text-sidebar-primary-foreground transition-transform
                  duration-200
